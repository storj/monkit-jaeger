...
func (p *AgentClient) EmitBatch(ctx context.Context, batch *jaeger.Batch) (err error) {
	...
	_args0.Batch = batch
	if err := p.Client_().Call(ctx, "emitBatch", &_args0, nil); err != nil {
		return err
	}
	return nil
}
...
func NewAgentProcessor(handler Agent) *AgentProcessor {
	...
	self1 := &AgentProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self1.processorMap["emitBatch"] = &agentProcessorEmitBatch{handler: handler}
	return self1
}
