...
func main() {
  ...
  case "emitBatch":
    ...
    arg3 := flag.Arg(1)
    mbTrans4 := thrift.NewTMemoryBufferLen(len(arg3))
    defer mbTrans4.Close()
    _, err5 := mbTrans4.WriteString(arg3)
    if err5 != nil {
      Usage()
      return
    }
    factory6 := thrift.NewTJSONProtocolFactory()
    jsProt7 := factory6.GetProtocol(mbTrans4)
    argvalue0 := jaeger.NewBatch()
    err8 := argvalue0.Read(context.Background(), jsProt7)
    if err8 != nil {
      Usage()
      return
    }
